...
%% PART 3: Import gene and chain lengths
tic; clear;
...
for i = 1:size(DATA, 1)
    ...
    TEMP = urlread(['https://rest.uniprot.org/uniprotkb/search?query=' DATA{i+size(DATA, 1)} '&format=tsv&fields=length,ft_signal,ft_chain,ft_peptide']);
